...
<div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
    ...
    <!-- Grid -->
     <div class="w3-center w3-padding-64"> 
     	<span class="w3-xlarge w3-bottombar w3-border-light-grey w3-padding-16"> Pair client with a program </span>
  	</div>
	<form class="w3-container" action="${pageContext.request.contextPath}/PairProgramToClientServlet" method="post" target="_blank" >
      ...
      <div class="w3-section">
        ...
        <select name="Program_name" id="Program_name" class="w3-input w3-border w3-hover-border-black" style="width:100%;" required>
