    ...
    <div class="w3-row-padding" id="actions">
        ...
        <div class="w3-third w3-margin-bottom">
            <ul class="w3-ul w3-border w3-center w3-hover-shadow">
                <li class="w3-xlarge w3-padding-32" style="background-color: #ac3973;"> New Seller </li>
        ...
        <div class="w3-third w3-margin-bottom">
            <ul class="w3-ul w3-border w3-center w3-hover-shadow">
                <li class="w3-xlarge w3-padding-32" style="background-color: #ac3973;"> New Program </li>
                <li class="w3-padding-16">
                    <h2 class="w3-wide"> Add new <br/> program </h2>
                    <form class="w3-container" target="_blank" >
                    	<p><a href="addProgram.jsp" class="w3-opacity">press here</a></p>
                    </form>
                </li>
            </ul>
        </div>
		...
		<div class="w3-third w3-margin-bottom">
            <ul class="w3-ul w3-border w3-center w3-hover-shadow">
                ...
                <li class="w3-padding-16">
                    <h2 class="w3-wide"> Change program details </h2>
                    <form class="w3-container" target="_blank">
