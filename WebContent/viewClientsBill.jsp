...
<div class="w3-content" style="max-width:1100px;margin-top:80px;margin-bottom:80px">
    ...
    <!-- Grid -->
    <div class="w3-row-padding" id="viewClientsBill">
       
		<%if(session.getAttribute("selectedClient") == "FALSE") {%>
			<div class="w3-center w3-padding-64">
            	<span class="w3-xlarge w3-bottombar w3-border-light-grey w3-padding-16"> Client's Bill </span>
        	</div>
			<form class="w3-container" action="${pageContext.request.contextPath}/ViewClientsBillServlet" method="get" target="_blank" >
		      ...
		      <button type="submit" class="w3-button w3-block" style="background-color: #ac3973;">Search</button>
		      <p><button type="reset" class="w3-button w3-block" style="background-color: #ac3973;">Clear</button></p>
    		</form>
		<%} else {%>
    	<%}%>
    </div>
  
    <form class="w3-container" action="${pageContext.request.contextPath}/ViewClientsBillServlet" method="post" target="_blank" >
		<%if(session.getAttribute("selectedClient") == "FALSE") {%>
   				...
   				<div class="w3-row-padding" id="clientsBill">
					...
					<fieldset class="w3-center w3-padding-32" >
							...
							<div>
								...
								<table style="margin-top: 17px; width: 95%;">
									<tr><td><button type="submit" onclick="sendEmail()" class="w3-button w3-block" style="background-color: #ac3973;">Print and Email</button></td></tr>
								</table>		
					    	</div>
				    </fieldset>	      
		    	</div>
